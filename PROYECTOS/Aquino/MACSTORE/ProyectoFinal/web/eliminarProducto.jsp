    ...
    <body>
        <div class="page">
            ...
            <div class="contenido">
                ...
                <form method="post" action="EliminarProd">
                        <h1>ELIMINAR PRODUCTO</h1><a href="mantProducto.jsp">VOLVER</a>
                        <table>
                            <tr>
                                <td>Producto :</td>
                            ...
                            <tr>
                                <td>Stock :</td>
                                <td><input type="text" name="stock" value="${requestScope.bean.stock}" readonly=""/></td>
                            </tr>
                            <tr>
                                <td>Estado :</td>
