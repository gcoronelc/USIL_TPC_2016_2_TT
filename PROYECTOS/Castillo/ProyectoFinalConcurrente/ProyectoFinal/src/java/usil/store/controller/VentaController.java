...
import usil.store.model.Detalle;
import usil.store.model.Producto;
import usil.store.model.Usuario;
import usil.store.model.Venta;
import usil.store.service.ServiceProducto;
import usil.store.service.ServiceVenta;
...
public class VentaController extends HttpServlet {
  ...
  public void init() throws ServletException {
    productoService = new ServiceProducto();
    ventaService = new ServiceVenta();
  }
