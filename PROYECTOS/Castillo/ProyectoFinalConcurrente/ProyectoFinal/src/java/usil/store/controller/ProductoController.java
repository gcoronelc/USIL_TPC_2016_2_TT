...
import usil.store.model.Producto;
import usil.store.service.ServiceProducto;

@WebServlet(name = "ProductoController", urlPatterns = {"/ConsultaProducto", "/ProdEditar",
    "/ProdEliminar", "/NuevoProd", "/ModificarProd", "/EliminarProd","/ConProdu"})
public class ProductoController extends HttpServlet {
    ...
    private void conpro(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
 try {
            // Datos
            Producto bean = new Producto();
            bean.setCodigo(Integer.parseInt(request.getParameter("codigo")));
        ...
        // Forward
        forward(request, response, "consultaProducto.jsp");    }
