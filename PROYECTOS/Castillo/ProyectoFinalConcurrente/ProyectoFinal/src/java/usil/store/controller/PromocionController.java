...
import usil.store.model.Promocion;
import usil.store.service.ServicePromocion;


@WebServlet(name = "PromocionController", urlPatterns = {"/ConsultaPromo", "/PromoEditar", "/PromoEliminar",
    "/NuevoPromo", "/ModificarPromo", "/EliminarPromo","/ConPromo"})
public class PromocionController extends HttpServlet {
    ...
    private void consulta(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            // Proceso
            ServicePromocion service = new ServicePromocion();
    ...
    private void compromo(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
        ...
        // Forward
        forward(request, response, "consultaPromocion.jsp");
